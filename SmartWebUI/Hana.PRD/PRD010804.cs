...
namespace Hana.PRD
{
    public partial class PRD010804 : Miracom.SmartWeb.UI.Controls.udcCUSReport002
    {
        /// <summary>
        /// 클  래  스: PRD010804<br/>
        ...
        /// 변경  내용: <br/>
        /// 2013-01-11-임종우 : STD 에서 PRD로 변경, 불필요한 Source 정리 및 수정        
        /// </summary>
        public PRD010804()
        {
            InitializeComponent();
        ...
        private void GridColumnInit()
        {
            ...
            spdData.RPT_AddBasicColumn("Equipment name", 0, 0, Visibles.True, Frozen.True, Align.Left, Merge.True, Formatter.String, 60);
            spdData.RPT_AddBasicColumn("Customer", 0, 1, Visibles.False, Frozen.True, Align.Center, Merge.True, Formatter.String, 80);
            ...
            spdData.RPT_AddBasicColumn("Type1", 0, 4, Visibles.False, Frozen.True, Align.Center, Merge.True, Formatter.String, 80);
            spdData.RPT_AddBasicColumn("Type2", 0, 5, Visibles.False, Frozen.True, Align.Center, Merge.True, Formatter.String, 80);
            spdData.RPT_AddBasicColumn("LD Count", 0, 6, Visibles.False, Frozen.True, Align.Center, Merge.True, Formatter.String, 80);
            spdData.RPT_AddBasicColumn("Density", 0, 7, Visibles.False, Frozen.True, Align.Center, Merge.True, Formatter.String, 80);
            spdData.RPT_AddBasicColumn("Generation", 0, 8, Visibles.False, Frozen.True, Align.Center, Merge.True, Formatter.String, 80);
            spdData.RPT_AddBasicColumn("Maj Code", 0, 9, Visibles.False, Frozen.True, Align.Left, Merge.True, Formatter.String, 80);             
            spdData.RPT_AddBasicColumn("제품", 0, 10, Visibles.True, Frozen.True, Align.Left, Merge.True, Formatter.String, 60);

            spdData.RPT_AddBasicColumn("공정", 0, 11, Visibles.True, Frozen.False, Align.Left, Merge.True, Formatter.String, 60);
            spdData.RPT_AddBasicColumn("Equipment status", 0, 12, Visibles.True, Frozen.False, Align.Center, Merge.True, Formatter.String, 70);
            spdData.RPT_AddBasicColumn("TAPE", 0, 13, Visibles.True, Frozen.False, Align.Left, Merge.True, Formatter.String, 70);
            spdData.RPT_AddBasicColumn("WBL_TAPE", 0, 14, Visibles.True, Frozen.False, Align.Left, Merge.True, Formatter.String, 70);
            spdData.RPT_AddBasicColumn("TARGET", 0, 15, Visibles.True, Frozen.False, Align.Left, Merge.True, Formatter.String, 70);
            spdData.RPT_AddBasicColumn("BLADE", 0, 16, Visibles.True, Frozen.False, Align.Left, Merge.True, Formatter.String, 70);
            spdData.RPT_AddBasicColumn("SUBSTRATE", 0, 17, Visibles.True, Frozen.False, Align.Center, Merge.True, Formatter.String, 70);
            spdData.RPT_AddBasicColumn("CAP", 0, 18, Visibles.True, Frozen.False, Align.Left, Merge.True, Formatter.String, 70);
            spdData.RPT_AddBasicColumn("GOLDWIRE", 0, 19, Visibles.True, Frozen.False, Align.Left, Merge.True, Formatter.String, 70);
            spdData.RPT_AddBasicColumn("EMC", 0, 20, Visibles.True, Frozen.False, Align.Left, Merge.True, Formatter.String, 70);
            spdData.RPT_AddBasicColumn("SB", 0, 21, Visibles.True, Frozen.False, Align.Left, Merge.True, Formatter.String, 70);
            spdData.RPT_AddBasicColumn("TRAY", 0, 22, Visibles.True, Frozen.False, Align.Left, Merge.True, Formatter.String, 70);            
