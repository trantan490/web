...
namespace Hana.PRD
{
    public partial class PRD010414 : Miracom.SmartWeb.UI.Controls.udcCUSReport002
    {
        /// <summary>
        /// 클  래  스: PRD010414<br/>
        /// 클래스요약: 공정 실적(SAP Interface 용)<br/>
        /// 작  성  자: 하나마이크론 임종우<br/>
        /// 최초작성일: 2011-12-02<br/>
        /// 상세  설명: 공정 실적(SAP Interface 용-정비재C 요청)<br/>
        /// 변경  내용: <br/>       
        /// 2011-12-07-임종우 : 전송 여부 검색 조건 추가 - 성공, 실패
        /// 2012-02-10-김민우 : 기간으로 검색기능 추가 22시기준일때는(TO_DATE) 06기준일때는(FROM_DATE) 검색 기준으로 사용 
        /// </summary>
        public PRD010414()
        {
            try
        ...
        {            
            try
            {
                ...
                if (cboS.SelectedIndex == 0)
                {
                    ...
                    spdData.RPT_AddBasicColumn("BOH", 0, 14, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);
                    spdData.RPT_AddBasicColumn("SUBUL_IN", 0, 15, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);
                    spdData.RPT_AddBasicColumn("SUBUL_OUT", 0, 16, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);
                    spdData.RPT_AddBasicColumn("SUBUL_LOSS", 0, 17, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);
                    spdData.RPT_AddBasicColumn("SUBUL_CV", 0, 18, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);
                    spdData.RPT_AddBasicColumn("EOH", 0, 19, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);
                    spdData.RPT_AddBasicColumn("FROM_DATE", 0, 20, Visibles.True, Frozen.False, Align.Center, Merge.False, Formatter.String, 80);
                    spdData.RPT_AddBasicColumn("TO_DATE", 0, 21, Visibles.True, Frozen.False, Align.Center, Merge.False, Formatter.String, 80);
                    spdData.RPT_AddBasicColumn("FROM_TIME", 0, 22, Visibles.True, Frozen.False, Align.Center, Merge.False, Formatter.String, 80);
                    spdData.RPT_AddBasicColumn("TO_TIME", 0, 23, Visibles.True, Frozen.False, Align.Center, Merge.False, Formatter.String, 80);
                    spdData.RPT_AddBasicColumn("RESULT_REC", 0, 24, Visibles.True, Frozen.False, Align.Center, Merge.False, Formatter.String, 80);
                    spdData.RPT_AddBasicColumn("WORK_STATUS", 0, 25, Visibles.True, Frozen.False, Align.Center, Merge.False, Formatter.String, 80);
                    spdData.RPT_AddBasicColumn("E_RETCD", 0, 26, Visibles.True, Frozen.False, Align.Center, Merge.False, Formatter.String, 80);
                    spdData.RPT_AddBasicColumn("E_ERRMSG", 0, 27, Visibles.True, Frozen.False, Align.Center, Merge.False, Formatter.String, 80); 
                }
                ...
                else if (cboS.SelectedIndex == 1)
                {
                    ...
                    spdData.RPT_AddBasicColumn("SUBUL_IN", 0, 5, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);
                    spdData.RPT_AddBasicColumn("SUBUL_OUT", 0, 6, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);
                    spdData.RPT_AddBasicColumn("SUBUL_LOSS", 0, 7, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);
                    spdData.RPT_AddBasicColumn("SUBUL_CV", 0, 8, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);
                    spdData.RPT_AddBasicColumn("EOH", 0, 9, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);
                }
        ...
        private string MakeSqlString()
        {
            ...
            if (cboS.SelectedIndex == 0)
            {
                ...
                strSqlString.Append("  FROM MESMGR.ISAPSUBUL@RPTTOMES " + "\n");
            ...
            else if (cboS.SelectedIndex == 1)
            {
                ...
                strSqlString.Append("     , SUM(BOH), SUM(SUBUL_IN), SUM(SUBUL_OUT), SUM(SUBUL_LOSS), SUM(SUBUL_CV), SUM(EOH) " + "\n");
                strSqlString.Append("  FROM MESMGR.ISAPSUBUL@RPTTOMES " + "\n");
                strSqlString.Append(" WHERE 1=1 " + "\n");
                strSqlString.Append("   AND MAT_ID LIKE '" + txtMatID.Text + "'" + "\n");
