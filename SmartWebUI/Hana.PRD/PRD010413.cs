...
namespace Hana.PRD
{
    public partial class PRD010413 : Miracom.SmartWeb.UI.Controls.udcCUSReport002
    {
        /// <summary>
        /// 클  래  스: PRD010413<br/>
        /// 클래스요약: 제품별 생산시간(SAP 전송용)<br/>
        /// 작  성  자: 하나마이크론 임종우<br/>
        /// 최초작성일: 2011-12-01<br/>
        /// 상세  설명: 제품별 생산시간(SAP 전송용-정비재C 요청)<br/>
        /// 변경  내용: <br/>        
        /// </summary>
        public PRD010413()
        {
        ...
        {            
            try
            {
                ...
                spdData.RPT_AddBasicColumn("QUEUE_TIME", 0, 13, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);
                spdData.RPT_AddBasicColumn("HOLD_TIME", 0, 14, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);
                spdData.RPT_AddBasicColumn("PROC_TIME", 0, 15, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Number, 80);                
                spdData.RPT_AddBasicColumn("RMK", 0, 16, Visibles.True, Frozen.False, Align.Center, Merge.False, Formatter.String, 80);
            }
            catch (Exception ex)
            {
                CmnFunction.ShowMsgBox(ex.Message);
        ...
        private string MakeSqlString()
        {
            ...
            strSqlString.Append("  FROM RSAPMESPTM A " + "\n");
