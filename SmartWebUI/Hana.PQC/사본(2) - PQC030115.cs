    ...
    public partial class PQC030115 : Miracom.SmartWeb.UI.Controls.udcCUSReport002
    {
		...
		private void fnSSInitial(Miracom.SmartWeb.UI.Controls.udcFarPoint SS)
		{
			...
			try
			{
				...
				SS.RPT_ColumnInit();
				SS.RPT_AddBasicColumn("고객사", 0, iindex + 0, Visibles.True, Frozen.False, Align.Center, Merge.True, Formatter.String, 100);
				SS.RPT_AddBasicColumn("PACKAGE", 0, iindex + 1, Visibles.True, Frozen.False, Align.Center, Merge.True, Formatter.String, 100);
				SS.RPT_AddBasicColumn("공정", 0, iindex + 2, Visibles.True, Frozen.False, Align.Center, Merge.True, Formatter.String, 100);
				SS.RPT_AddBasicColumn("불량코드", 0, iindex + 3, Visibles.True, Frozen.False, Align.Center, Merge.True, Formatter.String, 100);
				...
				SS.RPT_AddBasicColumn("금", 0, iindex + 11, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Double2, 80);
				SS.RPT_AddBasicColumn("토", 0, iindex + 12, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Double2, 80);
				...
				SS.RPT_AddBasicColumn("화", 0, iindex + 15, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Double2, 80);
				SS.RPT_AddBasicColumn("수", 0, iindex + 16, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Double2, 80);
				SS.RPT_AddBasicColumn("목", 0, iindex + 17, Visibles.True, Frozen.False, Align.Right, Merge.False, Formatter.Double2, 80);
			}
			catch (Exception ex)
			{
        ...
        //private bool fnDataFind_Backup()
        //{
        //    /****************************************************
        //     * Comment : DataBase에 저장된 데이터를 조회한다.
        //     * 
