...
namespace Hana.TRN
{
    public partial class PQC030118 : Miracom.SmartWeb.UI.Controls.udcCUSReport002
    {
        ...
        private void GridColumnInit()
        {
            ...
            try
            {
                ...
                spdData.RPT_AddBasicColumn("불량율", 0, 5, Visibles.True, Frozen.True, Align.Center, Merge.False, Formatter.Double2, 50);
        ...
        private void GetFirstDay()
        {
            ...
            strSqlString.Append("   AND SYS_YEAR||PLAN_WEEK = " + cdvFromToDate.HmFromWeek + "\n");
        ...
        private void GetLastDay()
        {
            ...
            strSqlString.Append("SELECT SYS_DATE, SYS_YEAR||PLAN_WEEK FROM MWIPCALDEF" + "\n");
            strSqlString.Append(" WHERE CALENDAR_ID = 'HM'" + "\n");
            strSqlString.Append("   AND SYS_YEAR||PLAN_WEEK = " + cdvFromToDate.HmToWeek + "\n");
            strSqlString.Append("ORDER BY SYS_DATE" + "\n");

            dtLast = CmnFunction.oComm.GetFuncDataTable("DYNAMIC", strSqlString.ToString());
            dayArry[1] = dtLast.Rows[6][0].ToString(); // 금 주 마지막일자
