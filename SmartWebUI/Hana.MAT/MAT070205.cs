...
namespace Hana.MAT
{
    public partial class MAT070205 : Miracom.SmartWeb.UI.Controls.udcCUSReport002
    {
        ...
        /// 변경  내용: 2012-07-09-배수민 : 구분코드에 부자재출고 조회 추가 (박찬식K 요청)<br/>
        ...
        private void SortInit()
        {
            ...
            //else
            //{
            //    ((udcTableForm)(this.btnSort.BindingForm)).AddRow("타입", "B.MAT_TYPE", "B.MAT_TYPE", true);
            //    ((udcTableForm)(this.btnSort.BindingForm)).AddRow("품명", "B.MAT_DESC", "B.MAT_DESC", true);
            //    ((udcTableForm)(this.btnSort.BindingForm)).AddRow("Item Code", "A.MAT_ID", "A.MAT_ID", true);
            //}
        }
        #endregion
        ...
        private string MakeSqlString()
        {
            ...
            else
            {
                ...
                {
                    //if (cboTranCode.Text == "입고")
                    if (cboTranCode.SelectedIndex == 0)
                    {
                        strSqlString.Append("      , SUM(QUANTITY) AS ISSUE_CNT " + "\n");
                    }
                    //else if (cboTranCode.Text == "부자재출고")
                    else if (cboTranCode.SelectedIndex == 3)
                    {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (cdvStorage.Text == "")
                {
                    MessageBox.Show(" WMS INFO - 저장위치를 선택하세요. ");
                    return;
                }
