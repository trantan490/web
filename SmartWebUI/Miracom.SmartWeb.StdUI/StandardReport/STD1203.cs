...
{
    public partial class STD1203 : Miracom.SmartWeb.FWX.udcUIBase
    {
        public STD1203()
        {
            InitializeComponent();
        ...
        private void STD1203_Load(object sender, EventArgs e)
        {
        ...
        private Boolean CheckField()
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD001", GlobalVariable.gcLanguage), "STD1203");
                Check = false;
            }
            else { Check = true; }
        ...
        private void MakeChart(DataTable DT)
        {
            ...
            RptUChart.UChartOption.UChartTitle(ultraChart1, "STD1203 " + label3.Text);
        ...
        private void btnExcelExport_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD002", GlobalVariable.gcLanguage), "STD1203");
                return;
            }
