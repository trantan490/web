...
{
    public partial class STD1104 : Miracom.SmartWeb.FWX.udcUIBase
    {
        public STD1104()
        {
            InitializeComponent();
        ...
        private void STD1104_Load(object sender, EventArgs e)
        {
        ...
        private Boolean CheckField()
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD001", GlobalVariable.gcLanguage), "STD1104");
                Check = false;
            }
            else { Check = true; }
        ...
        private void MakeChart(DataTable DT)
        {
            ...
            Table = RptUChart.GetDataColKey(DT, 0, 2, 1);
           
            RptUChart.UChartOption.Legend.ShowLegend(ultraChart1, "Right");
            RptUChart.UChartOption.UChartTitle(ultraChart1, "STD1104 " + label3.Text);
        ...
        private void btnExcelExport_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD002", GlobalVariable.gcLanguage), "STD1104");
                return;
            }
