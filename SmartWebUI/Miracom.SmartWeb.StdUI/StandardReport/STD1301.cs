...
{
    public partial class STD1301 : Miracom.SmartWeb.FWX.udcUIBase
    {
        public STD1301()
        {
            InitializeComponent();
        ...
        private void STD1301_Load(object sender, EventArgs e)
        {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            this.Refresh();
            dt = CmnFunction.oComm.GetFuncDataTable("STD1301", QueryCond);
        ...
        private Boolean CheckField()
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD001", GlobalVariable.gcLanguage), "STD1301");
                Check = false;
            }
            else if (cdvOper.Text.TrimEnd() == "")
            {
                MessageBox.Show(RptMessages.GetMessage("STD005", GlobalVariable.gcLanguage), "STD1301");
                Check = false;
            }
            else if (cdvMat.Text.TrimEnd() != "")
            {
                ...
                {
                    MessageBox.Show(RptMessages.GetMessage("STD011", GlobalVariable.gcLanguage), "STD1301");
                    Check = false;
                }
                Check = true;
            }
        ...
        private void MakeChart(DataTable DT)
        {
            ...
            RptUChart.UChartOption.UChartTitle(ultraChart1, "STD1301 " + label3.Text);
        ...
        private void btnExcelExport_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD002", GlobalVariable.gcLanguage), "STD1301");
                return;
            }
        ...
        private void cdvMatVer_ButtonPress(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD006", GlobalVariable.gcLanguage), "STD1301");
                return;
            }
            cdvMatVer.Init();
