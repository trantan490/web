...
{
    public partial class STD1109 : Miracom.SmartWeb.FWX.udcUIBase
    {
        public STD1109()
        {
            InitializeComponent();
        ...
        private void STD1109_Load(object sender, EventArgs e)
        {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            this.Refresh();
            dt = CmnFunction.oComm.GetFuncDataTable("STD1109", QueryCond);
        ...
        private Boolean CheckField()
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD001", GlobalVariable.gcLanguage), "STD1109");
                Check = false;
            }
            else { Check = true; }
        ...
        {           
            ...
            RptUChart.UChartOption.UChartTitle(ultraChart1, "STD1109 " + label3.Text);
        ...
        private void btnExcelExport_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD002", GlobalVariable.gcLanguage), "STD1109");
                return;
            }
