...
{
    public partial class STD1205 : Miracom.SmartWeb.FWX.udcUIBase
    {
        public STD1205()
        {
            InitializeComponent();
        ...
        private void STD1205_Load(object sender, EventArgs e)
        {
        ...
        private Boolean CheckField()
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD001", GlobalVariable.gcLanguage), "STD1205");
                Check = false;
            }
            else { Check = true; }
        ...
        private void btnExcelExport_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD002", GlobalVariable.gcLanguage), "STD1205");
                return;
            }
