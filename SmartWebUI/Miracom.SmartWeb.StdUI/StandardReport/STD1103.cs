...
{
    public partial class STD1103 : Miracom.SmartWeb.FWX.udcUIBase
    {
        public STD1103()
        {
            InitializeComponent();
        ...
        private void STD1103_Load(object sender, EventArgs e)
        {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            this.Refresh();
            dt = CmnFunction.oComm.GetFuncDataTable("STD1103", QueryCond);
        ...
        private Boolean CheckField()
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD001", GlobalVariable.gcLanguage), "STD1103");
                Check = false;
            }
            else { Check = true; }
        ...
        private void MakeChart(DataTable DT)
        {
            ...
            RptUChart.UChartOption.UChartTitle(ultraChart1, "STD1103 " + label3.Text);
            RptUChart.UChartOption.VisibleYaxis(ultraChart1);
            RptUChart.UChartOption.DataPointLabel(ultraChart1, true, "BarChart", "<DATA_VALUE:0>");            
            RptUChart.ShowUChart(ultraChart1, Table, "BarChart");
        ...
        private void btnExcelExport_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD002", GlobalVariable.gcLanguage), "STD1103");
                return;
            }
