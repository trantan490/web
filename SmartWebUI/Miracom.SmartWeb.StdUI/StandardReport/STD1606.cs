...
{
    public partial class STD1606 : Miracom.SmartWeb.FWX.udcUIBase
    {
        public STD1606()
        {
            InitializeComponent();
        ...
        private void STD1606_Load(object sender, EventArgs e)
        {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            this.Refresh();
            dt = CmnFunction.oComm.GetFuncDataTable("STD1606", QueryCond);
        ...
        private Boolean CheckField()
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD001", GlobalVariable.gcLanguage), "STD1606");
                Check = false;
            }
            else { Check = true; }
        ...
        private void MakeChart(DataTable DT)
        {
            ...
            RptUChart.UChartOption.UChartTitle(ultraChart1, "STD1606 " + label3.Text);
        ...
        private void spdData_CellClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            string QueryCond = null;
            Hold_CODE = Convert.ToString(spdData.Sheets[0].Cells[e.Row, 1].Value);
            QueryCond = FwxCmnFunction.PackCondition(QueryCond, cdvFactory.Text);
            QueryCond = FwxCmnFunction.PackCondition(QueryCond, StartDate());
            QueryCond = FwxCmnFunction.PackCondition(QueryCond, EndDate());
            QueryCond = FwxCmnFunction.PackCondition(QueryCond, Hold_CODE);

            spdDataDetail_Sheet1.RowCount = 0;
            this.Refresh();
            dt = CmnFunction.oComm.GetFuncDataTable("STD1606_1", QueryCond);
