...
{
    public partial class STD1107 : Miracom.SmartWeb.FWX.udcUIBase
    {
        public STD1107()
        {
            InitializeComponent();
        ...
        private void STD1107_Load(object sender, EventArgs e)
        {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            this.Refresh();
            dt = CmnFunction.oComm.GetFuncDataTable("STD1107", QueryCond);
        ...
        private Boolean CheckField()
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD001", GlobalVariable.gcLanguage), "STD1107");
                Check = false;
            }
            else { Check = true; }
        ...
        private void MakeChart(DataTable DT)
        {
            ...
            RptUChart.UChartOption.UChartTitle(ultraChart1, "STD1107 " + label3.Text);
        ...
        private void btnExcelExport_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD002", GlobalVariable.gcLanguage), "STD1107");
                return;
            }
