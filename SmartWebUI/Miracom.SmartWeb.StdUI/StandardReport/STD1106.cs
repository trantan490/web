...
{
    public partial class STD1106 : Miracom.SmartWeb.FWX.udcUIBase
    {
        public STD1106()
        {
            InitializeComponent();
        ...
        private void STD1106_Load(object sender, EventArgs e)
        {
        ...
        private Boolean CheckField()
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD001", GlobalVariable.gcLanguage), "STD1106");
                Check = false;
            }
            else if (cdvMatType.Text.TrimEnd() == "")
            {
                MessageBox.Show(RptMessages.GetMessage("STD003", GlobalVariable.gcLanguage), "STD1106");
                Check = false;
            }
            else if (cdvMatGrp.Text.TrimEnd() == "")
            {
                MessageBox.Show(RptMessages.GetMessage("STD004", GlobalVariable.gcLanguage), "STD1106");
                Check = false;
            }
            else { Check = true; }
