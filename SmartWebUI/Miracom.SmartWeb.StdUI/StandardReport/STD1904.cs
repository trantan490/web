...
{
    public partial class STD1904 : Miracom.SmartWeb.FWX.udcUIBase
    {
        ...
        private void STD1904_Load(object sender, EventArgs e)
        {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            this.Refresh();
            dt = CmnFunction.oComm.GetFuncDataTable("STD1904", QueryCond);
        ...
        private Boolean CheckField()
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD001", GlobalVariable.gcLanguage), "STD1904");
                Check = false;
            }
            else if (cdvRes.Text.TrimEnd() == "")
            {
                MessageBox.Show(RptMessages.GetMessage("STD008", GlobalVariable.gcLanguage), "STD1904");
                Check = false;
            }
            else { Check = true; }
        ...
        private void btnExcelExport_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD002", GlobalVariable.gcLanguage), "STD1904");
                return;
            }

            CmnExcelFunction.ExportToExcel(spdData, "Quality", "", true, false, false, -1, -1);
        }
