...
{
    public partial class STD1402 : Miracom.SmartWeb.FWX.udcUIBase
    {
        public STD1402()
        {
            InitializeComponent();
        ...
        private void STD1402_Load(object sender, EventArgs e)
        {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            this.Refresh();
            dt = CmnFunction.oComm.GetFuncDataTable("STD1402", QueryCond);
        ...
        private Boolean CheckField()
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD001", GlobalVariable.gcLanguage), "STD1402");
                Check = false;
            }
            else if (cdvMat.Text.TrimEnd() != "")
            {
                ...
                {
                    MessageBox.Show(RptMessages.GetMessage("STD011", GlobalVariable.gcLanguage), "STD1402");
                    Check = false;
                }
                Check = true;
            }
        ...
        private void btnExcelExport_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD002", GlobalVariable.gcLanguage), "STD1402");
                return;
            }
