...
{
    public partial class STD1605 : Miracom.SmartWeb.FWX.udcUIBase
    {
        public STD1605()
        {
            InitializeComponent();
        ...
        private void STD1605_Load(object sender, EventArgs e)
        {
        ...
        private Boolean CheckField()
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD001", GlobalVariable.gcLanguage), "STD1605");
                Check = false;
            }
            else { Check = true; }
        ...
        private void MakeChart(DataTable DT)
        {
            ...
            Table = RptUChart.GetData(DT, 1, 3, 1);

            RptUChart.UChartOption.Legend.ShowLegend(ultraChart1, "Right");
            RptUChart.UChartOption.UChartTitle(ultraChart1, "STD1605 " + label3.Text);
        ...
        private void btnExcelExport_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(RptMessages.GetMessage("STD002", GlobalVariable.gcLanguage), "STD1605");
                return;
            }
        ...
        {
            DataTable dt = null;
            string RWK_CODE = null;
            string QueryCond = null;
            RWK_CODE = Convert.ToString(spdData.Sheets[0].Cells[e.Row, 1].Value);
            QueryCond = FwxCmnFunction.PackCondition(QueryCond, cdvFactory.Text);
            QueryCond = FwxCmnFunction.PackCondition(QueryCond, StartDate());
            QueryCond = FwxCmnFunction.PackCondition(QueryCond, EndDate());
            QueryCond = FwxCmnFunction.PackCondition(QueryCond, RWK_CODE);

            spdDataDetail_Sheet1.RowCount = 0;
            this.Refresh();
            dt = CmnFunction.oComm.GetFuncDataTable("STD1605_1", QueryCond);
