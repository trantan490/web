...
{
    public partial class udcCUSReportUpload002 : Miracom.SmartWeb.FWX.udcUIBase
    {
        ...
        private bool View_EQErr(bool bValidation)
        {
            DataTable dt = null;
            ...
            {
                CmnFunction.ShowMsgBox("udcCUSReportUpload002.View_Plan() " + "\r\n" + ex.ToString());
            }

            return true;
        }

        private void View_EQErr_List()
        {
            ...
            {
                CmnFunction.ShowMsgBox("udcCUSReportUpload002.View_Plan_List() " + "\r\n" + ex.ToString());
            }
        }

        private bool Update_EQErr_Data(string sStep)
        {
        ...
        private void udcCUSReportUpload002_Load(object sender, EventArgs e)
        {         
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            {
                CmnFunction.ShowMsgBox("udcCUSReportUpload002.btnClose_Click()" + "\r\n" + ex.Message);
            }
        }
