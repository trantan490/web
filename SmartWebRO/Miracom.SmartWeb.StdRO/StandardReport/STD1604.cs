...
namespace Miracom.SmartWeb.RO
{
    ...
    {
        public DataTable STD1604(ArrayList TempList)
        {
            ...
            try
            {
                ...
                {
                    RetDT = StdGlobalVariable.DBQuery.GetFuncDataTable("STD1604", null, new string[] { CondList[0], CondList[1], CondList[2]});
