...
namespace Miracom.SmartWeb.RO
{
    ...
    {
        public DataTable STD1606(ArrayList TempList)
        {
            ...
            try
            {
                ...
                {
                    RetDT = StdGlobalVariable.DBQuery.GetFuncDataTable("STD1606", null, new string[] { CondList[0], CondList[1], CondList[2]});
                    ...
                    if (RetDT.Rows.Count > 0)
                    {
                        for (i = 0; i < 4; i++)
                        {
                            ...
                            {
                                Col.ColumnName = "Hold Code Desc";
                                Col.DataType = System.Type.GetType("System.String");
                            }
                            else if (i == 3)
                            {
                                Col.ColumnName = "Hold Count";
                                Col.DataType = System.Type.GetType("System.String");
                            }
