...
#region " Fields Definition "
    ...
    private int m_image_idx;                                 // INTEGER(3)
...
#region " Property Definition "
    ...
    /// <summary>
    /// Gets or sets the 'IMAGE_IDX' value.
    /// </summary>
...
#region " Function Definition "
    ...
    public object Clone()
    {
        DBC_MFMBRESIMG MFMBRESIMG = null;
        try
        {
            MFMBRESIMG = new DBC_MFMBRESIMG(ref _dbc);

            MFMBRESIMG.FACTORY = this.FACTORY;
            MFMBRESIMG.RES_ID = this.RES_ID;
            MFMBRESIMG.IMAGE_IDX = this.IMAGE_IDX;
        }
        catch(Exception ex)
        {
    ...
    public bool CopyDataRow(DataRow Row)
    {
        try
        {
            ...
            IMAGE_IDX = Convert.ToInt32(Row["IMAGE_IDX"]);
        }
        catch(Exception ex)
        {
            if (ex.GetType().ToString() == "System.Data.OleDb.OleDbException")
        ...
        try
        {
            ...
            switch(_step)
            {
                case 1:
                    ...
                    strQuery = "SELECT * FROM MFMBRESIMG"
                        + " WHERE FACTORY=?"
                        + " AND RES_ID=?";
            ...
            for(i = 0 ; i <= adoDataTable.Columns.Count - 1; i++)
            {
                switch(adoDataTable.Columns[i].ColumnName)
                {
                    ...
                    case "RES_ID":
                        ...
                        break;
                    case "IMAGE_IDX":
                        IMAGE_IDX = Convert.ToInt32(adoDataTable.Rows[0]["IMAGE_IDX"]);
                        break;
                }
            }
        ...
        try
        {
            ...
            switch(_step)
            {
                case 1:
                    ...
                    strQuery = "SELECT COUNT(*) FROM MFMBRESIMG"
                        + " WHERE FACTORY=?"
                        + " AND RES_ID=?";
        ...
        try
        {
            ...
            switch(_step)
            {
                case 1:
                    ...
                    strQuery = "DELETE FROM MFMBRESIMG"
                        + " WHERE FACTORY=?"
                        + " AND RES_ID=?";
    ...
    public bool InsertData()
    {
        ...
        try
        {
            ...
            strQuery = "INSERT INTO MFMBRESIMG ("
            ...
            adoCommand.Parameters.Add("@FACTORY", OleDbType.VarChar).Value = FACTORY;
            adoCommand.Parameters.Add("@RES_ID", OleDbType.VarChar).Value = RES_ID;
            adoCommand.Parameters.Add("@IMAGE_IDX", OleDbType.Numeric).Value = IMAGE_IDX;
        ...
        try
        {
            ...
            switch(_step)
            {
                case 1:
                    ...
                    strQuery = "UPDATE MFMBRESIMG SET"
                        + " IMAGE_IDX=?"
                        + " WHERE FACTORY=?"
                        + " AND RES_ID=?";
